...
@RequestMapping(value = KafkaAccountController.CONTEXT_V1_ACCOUNT)
...
public class KafkaAccountController{
	...
	public static final String CONTEXT_1 = "http:/localhost:8090/"; 
    ...
    public KafkaAccountController(KafkaAccountProducerService accountProducerService) {
